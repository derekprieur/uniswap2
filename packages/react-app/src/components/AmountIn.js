...
const AmountIn = ({ value, onChange, currencyValue, onSelect, currencies, isSwapping }) => {
    ...
    return (
        <div className={styles.amountContainer}>
            <input placeholder='0.0' type='number' value={value} disabled={isSwapping} onChange={(e) => typeof onChange === 'function' && onChange(e.target.value)} className={styles.amountInput}></input>
